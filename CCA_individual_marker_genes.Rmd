...
colnames_FL <- colnames(geneabund_drep_marker_taxa)[which(grepl(paste(metadata_METAG_FL$AccessionNumber_TBDSven, collapse="|"), colnames(geneabund_drep_marker_taxa)))]
colnames_METAG_FL <- colnames_FL[grep("METAG", colnames_FL)]

viral_diversity_FL <- geneabund_drep_marker_taxa[,colnames_METAG_FL] 
colnames_METAT_FL <- colnames_FL[grep("METAT", colnames_FL)]
viral_activity_FL <- geneabund_drep_marker_taxa[,colnames_METAT_FL] 
#LF
...
colnames_METAG_LF <- colnames(geneabund_drep_marker_taxa)[which(grepl(paste(metadata_METAG_LF$AccessionNumber_TBDSven, collapse="|"), colnames(geneabund_drep_marker_taxa)))]
colnames_METAG_LF <- colnames_METAG_LF[which(grepl("METAG", colnames_METAG_LF))]

viral_diversity_LF <- geneabund_drep_marker_taxa[,colnames_METAG_LF] 
colnames_METAT_LF <- colnames_METAG_LF[which(grepl("METAT", colnames_METAG_LF))]
viral_activity_LF <- geneabund_drep_marker_taxa[,colnames_METAT_LF] 
#HF
...
colnames_METAG_HF <- colnames(geneabund_drep_marker_taxa)[which(grepl(paste(metadata_METAG_HF$AccessionNumber_TBDSven, collapse="|"), colnames(geneabund_drep_marker_taxa)))]
colnames_METAG_HF <- colnames_METAG_HF[which(grepl("METAG", colnames_METAG_HF))]

viral_diversity_HF <- geneabund_drep_marker_taxa[,colnames_METAG_HF] 
colnames_METAT_HF <- colnames_METAG_HF[which(grepl("METAT", colnames_METAG_HF))]
viral_activity_HF <- geneabund_drep_marker_taxa[,colnames_METAT_HF] 
