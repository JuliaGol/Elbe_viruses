...
viral_activity <- log((viral_activity_paired + pseudocount)/(viral_diversity_paired + pseudocount))
...
#viral_activity_FL <- viral_activity_FL
viral_activity_FL.dist <- vegdist(t(viral_activity_FL), method = "euclidean", na.rm = T)
#param distances
...
#save.image("C:/Users/jgolebiowska/Documents/IGB_phd/virus/viral_abundances/mantel_test/mantel_test_elbe.RData")
```
...
tiff("C:/Users/jgolebiowska/Documents/IGB_phd/virus/viral_abundances/mantel_test/mantel_plots/mantel_test_METAG_FL_plot_avrdist_bray.tiff",width=770,height=300,units="px")
...
# dev.off()
tiff("C:/Users/jgolebiowska/Documents/IGB_phd/virus/viral_abundances/mantel_test/mantel_plots/mantel_test_METAT_FL_plot_log_euclidean.tiff",width=770,height=300)
mantel_test_METAT_FL_plot
dev.off()
```
##4. Light fraction
...
viral_activity_LF.dist <- vegdist(t(viral_activity_LF), method = "euclidean", na.rm = T)
...
vec_param <- colnames(metadata_METAG_LF)[-c(1:6, 8, 35,36, 37)]
...
if (names(list.METAT_LF.dists)[i] == "viral_activity" & colnames(matrix_res_sig_METAT_LF)[j] == "viral_activity" ){
      next
    }  
...
tiff("C:/Users/jgolebiowska/Documents/IGB_phd/virus/viral_abundances/mantel_test/mantel_plots/mantel_test_METAG_LF_plot_avrdist_bray.tiff",width=770,height=300,units="px")
...
# filter(Var1 != "MOTUs") %>% 
 ...
 # guides(colour = guide_colorbar(title = "Mantel's r", frame.colour = "black", barwidth = 1.5)) +    #title.theme = element_text(angle=90, vjust=1))) +
  ...
  theme(rect = element_blank(),
        ...
        axis.text.y = element_text(size=15), 
        legend.position = "right") +  geom_text(vjust=0.76,hjust=0.49, aes(label = paste0(c("","*")[(abs(p_value.adj) <= .05)+1], c("","*")[(abs(p_value.adj) <= .001)+1], c("","*")[(abs(p_value.adj) <= .001)+1])))
# png("C:/Users/jgolebiowska/Documents/IGB_phd/virus/viral_abundances/mantel_plots/mantel_test_expression_LF_plot.png")
# mantel_test_METAT_LF_plot
# dev.off()
tiff("C:/Users/jgolebiowska/Documents/IGB_phd/virus/viral_abundances/mantel_test/mantel_plots/mantel_test_METAT_LF_plot_log_euclidean.tiff",width=770,height=300)
mantel_test_METAT_LF_plot
dev.off()
```
##5. Heavy fraction
...
viral_activity_HF.dist <- vegdist(t(viral_activity_HF), method = "euclidean", na.rm = T)
#param distances
#store in a list of distances 
...
vec_param <- colnames(metadata_METAG_HF)[-c(1:6, 8, 35,36, 37)]
...
if (names(list.METAT_HF.dists)[i] == "viral_activity" & colnames(matrix_res_sig_METAT_HF)[j] == "viral_activity" ){
      next
    }  
...
tiff("C:/Users/jgolebiowska/Documents/IGB_phd/virus/viral_abundances/mantel_test/mantel_plots/mantel_test_METAG_HF_plot_avrdist_bray.tiff",width=770,height=300,units="px")
...
# filter(Var1 != "MOTUs") %>% 
 ...
 # guides(colour = guide_colorbar(title = "Mantel's r", frame.colour = "black", barwidth = 1.5)) +    #title.theme = element_text(angle=90, vjust=1))) +
  ...
  theme(rect = element_blank(),
        ...
        axis.text.y = element_text(size=15), 
        legend.position = "right") +  geom_text(vjust=0.76,hjust=0.49, aes(label = paste0(c("","*")[(abs(p_value.adj) <= .05)+1], c("","*")[(abs(p_value.adj) <= .001)+1], c("","*")[(abs(p_value.adj) <= .001)+1])))
# png("C:/Users/jgolebiowska/Documents/IGB_phd/virus/viral_abundances/mantel_plots/mantel_test_expression_HF_plot.png")
# mantel_test_METAT_HF_plot
# dev.off()
tiff("C:/Users/jgolebiowska/Documents/IGB_phd/virus/viral_abundances/mantel_test/mantel_plots/mantel_test_METAT_HF_plot_log_euclidean.tiff",width=750,height=300)
mantel_test_METAT_HF_plot
dev.off()
```