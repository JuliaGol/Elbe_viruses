...
grid_METAG <- ggarrange(mantel_test_METAG_FL_plot, mantel_test_METAG_LF_plot, mantel_test_METAG_HF_plot, ncol = 1, nrow=3, legend="right", common.legend = TRUE, labels="auto") 
grid_METAT <- ggarrange(mantel_test_METAT_FL_plot, mantel_test_METAT_LF_plot,  mantel_test_METAT_HF_plot, ncol = 1, nrow=3, legend="right", common.legend = TRUE, labels="auto") 
tiff("mantel_plots/grid_METAG.tiff", unit="px", width = 700, height = 1000)
grid_METAG
dev.off()
tiff("mantel_plots/grid_METAT.tiff", unit="px", width = 700, height = 1000)
grid_METAT
dev.off()
```