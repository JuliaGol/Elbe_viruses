...
vir_genecluster_annot <- readRDS("data/vir_genecluster_annot.RDS")
...
saveRDS(vir_metag,  file="data/vir_metag.RDS")
saveRDS(vir_metat,  file="data/vir_metat.RDS")
...
#
saveRDS(vir_metag_paired,  file="data/vir_metag_paired.RDS")
saveRDS(vir_metat_paired,  file="data/vir_metat_paired.RDS")
print("paired done")
...
saveRDS(log_paired_vir_metag_paired,  file="data/log_paired_vir_metag_paired.RDS")
...
saveRDS(log_paired_vir_metat_paired,  file="data/log_paired_vir_metat_paired.RDS")
...
saveRDS(norm_expression_paired_vir, file="data/norm_expression_paired_vir.RDS")
...
saveRDS(log_vir_metag, file="data/log_vir_metag.RDS")
