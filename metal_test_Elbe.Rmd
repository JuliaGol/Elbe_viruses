...
#adjust p-values
matrix_res_sig_METAG$p_value.adj <- p.adjust(matrix_res_sig_METAG$p_value, method="bonferroni")
...
```{r}
#common plot for both - quite hard to read - no significant when adjusted p-values
